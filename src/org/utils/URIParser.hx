...
class URIParser
{
    ...
    // Privates
    static private var _parts : Array<String> = ["source","protocol","authority","userInfo","user","password","host","port","relative","path","directory","file","query","anchor"];
    ...
    public static function parse(url:String) : URIParser
    {
        return new URIParser(url);
    }
}